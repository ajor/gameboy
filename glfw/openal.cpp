...
void AudioOut::update_channel1(int freq)
{
  printf("Hello1 %d\n", freq);
  ...
  alBufferData(buffer[0], AL_FORMAT_MONO8, audio.get_channel_1(), 8, freq);
...
void AudioOut::update_channel2(int freq)
{
  printf("Hello2 %d\n", freq);
  ...
  alBufferData(buffer[1], AL_FORMAT_MONO8, audio.get_channel_2(), 8, freq);
